   ...
   public Connection conne = null;
    ...
    public dbConnweb() {
        try {
         ...
         conne = DriverManager.getConnection("jdbc:mysql://localhost:3306/grants?maxAllowedPacket=1000000000","root", "test");
         //conne = DriverManager.getConnection("jdbc:mysql://tujengejamii-db.mysql.database.azure.com:3306/aphiaplus_moi?verifyServerCertificate=false&useSSL=true&requireSSL=true&enabledTLSProtocols=TLSv1.2","tujengejamii@tujengejamii-db","usaidtj12345%");
         //conne = DriverManager.getConnection("jdbc:mysql://104.45.29.195:3306/aphiaplus_moi","root", "admin");
         // conne = DriverManager.getConnection("jdbc:mysql://localhost:3306/aphiaplus_moi?maxAllowedPacket=1000000000","root", "test");
