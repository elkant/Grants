 ...
 */
public class savesrlopbudget extends HttpServlet {
...
//        response.setContentType("text/html;charset=UTF-8");
 ...
 response.setContentType("text/html;charset=UTF-8");
        ...
        HttpSession ses= request.getSession(true);
            ...
            String table = " grants.subaward_lop_budget ";

           
//____Note, The table id should always come first so that the table id is pulled automatically on the hashmap 
            String[] dataelementsarr = {"table_id","subrec_id","currently_active","salaries","fringe_benefits","equipment","travel","supplies","other_direct_costs","indirect_costs","implementation_budget","cost_share","update_no","user_id"};
...
//______________________________________________________________________________________
            if (conn.pst1.executeUpdate() == 1) {
                out.println("Subrecipient Lop Data Saved Successfully");
saveresponse="<font color=\"green\">Subrecipient Lop Data Saved Successfully</font>";
    ...
    //_________________________________________________________________Transfer File into a Folder______________________________________________________        
      ...
      //This is currently inactive
        ...
        {     
            ...
            Logger.getLogger(savesrlopbudget.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        
        ses.setAttribute("subrecipientslopbudget_response",saveresponse);
        response.sendRedirect("subrecipients_lop_budget.jsp");
    }
