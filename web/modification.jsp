...
<input onkeyup="autosum('salaries,fringe_benefits,equipment,travel,supplies,other_direct_costs,indirect_costs','obligated_budget');" maxlength="10" onkeypress='return numbers(event);'  type='input' class='form-control' id='fringe_benefits' name='fringe_benefits'  placeholder='Enter Fridge Benefits'/>
</div>
