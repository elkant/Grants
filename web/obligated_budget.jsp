				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
							<li class="nav-item">
								<a class="nav-link active text-uppercase" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false">Update Obligated Budget</a>
							</li>
							<li class="nav-item">
...
<!--                        <h5>Form controls</h5>-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <form action="save_obligated_budget" >
                                    
						<h2 class='btn btn-success' style='text-align: center; width:100%;'><b>Update Sub-recipient's Obligated Budget</b></h2>
				<div class="form-row">
...
<input onkeyup="autosum('salaries,fringe_benefits,equipment,travel,supplies,other_direct_costs,indirect_costs','obligated_budget');" maxlength="10" onkeypress='return numbers(event);'  type='input' class='form-control' id='salaries' name='salaries'  placeholder='Enter Salaries'/>
</div>


<div class='form-group col-md-4'>
<label for='fringe_benefits'><b>Fringe Benefits<font color='red'>*</font></b></label>
<input onkeyup="autosum('salaries,fringe_benefits,equipment,travel,supplies,other_direct_costs,indirect_costs','obligated_budget');" maxlength="10" onkeypress='return numbers(event);'  type='input' class='form-control' id='fringe_benefits' name='fringe_benefits'  placeholder='Enter Fringe Benefits'/>
</div>


<div class='form-group col-md-4'>
<label for='equipment'><b>Equipment<font color='red'>*</font></b></label>
<input onkeyup="autosum('salaries,fringe_benefits,equipment,travel,supplies,other_direct_costs,indirect_costs','obligated_budget');" maxlength="10" onkeypress='return numbers(event);'  type='input' class='form-control' id='equipment' name='equipment'  placeholder='Enter Equipment'/>
</div>
...
<input onkeyup="autosum('salaries,fringe_benefits,equipment,travel,supplies,other_direct_costs,indirect_costs','obligated_budget');" onkemaxlength="10"ypress='return numbers(event);'  type='input' class='form-control' id='travel' name='travel'  placeholder='Enter Travel'/>
</div>


<div class='form-group col-md-4'>
<label for='supplies'><b>Supplies<font color='red'>*</font></b></label>
<input onkeyup="autosum('salaries,fringe_benefits,equipment,travel,supplies,other_direct_costs,indirect_costs','obligated_budget');" maxlength="10" onkeypress='return numbers(event);'  type='input' class='form-control' id='supplies' name='supplies'  placeholder='Enter Supplies'/>
</div>


<div class='form-group col-md-4'>
<label for='other_direct_costs'><b>Other Direct Costs<font color='red'>*</font></b></label>
<input onkeyup="autosum('salaries,fringe_benefits,equipment,travel,supplies,other_direct_costs,indirect_costs','obligated_budget');" maxlength="10" onkeypress='return numbers(event);'  type='input' class='form-control' id='other_direct_costs' name='other_direct_costs'  placeholder='Enter Other Direct Costs'/>
</div>
...
<input onkeyup="autosum('salaries,fringe_benefits,equipment,travel,supplies,other_direct_costs,indirect_costs','obligated_budget');" maxlength="10" onkeypress='return numbers(event);'  type='input' class='form-control' id='indirect_costs' name='indirect_costs'  placeholder='Enter Indirect Costs'/>
</div>

<div class='form-group col-md-4'>
<label for='obligated_budget'><b>Obligated Budget<font color='red'>*</font></b></label>
<input readonly="true" maxlength="10" onkeypress='return numbers(event);'  type='input' class='form-control' id='obligated_budget' name='obligated_budget'  placeholder='Enter Implementation Budget'/>
</div>
...
<div class='form-group col-md-4'>
<label for='obligation_end_date'><b>Obligation end Date<font color='red'>*</font></b></label>
<input maxlength="10" onkeypress='return numbers(event);'  type='input' class='form-control tarehe_kesho' id='obligation_end_date' name='obligation_end_date'  placeholder='Enter End Date'/>
</div>
...
<div class="toast-body"><p class='ujumbe'></p></div>
   ...
   <%if (session.getAttribute("subrecipientsobligatedbudget_response") != null) { %>
   <script type="text/javascript"> 
                    
                    var uju='<%=session.getAttribute("subrecipientsobligatedbudget_response")%>';
                    $('.ujumbe').html(uju);
                    $('.callalert').click();
                      
                    
                </script> <%
                session.removeAttribute("subrecipientsobligatedbudget_response");
                            }
...
//                    }});
  ...
  loadEdits('searchtable','obligation_infor','loadedits','vw_subrecipient_obl_bud','table_id'); 
